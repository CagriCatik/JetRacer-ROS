#!/usr/bin/env python3
# WARNING: Retaining python3 to match the hardware driver conventions.
...
def talker():
    ...
    #Get throttle and steering (Move outside while loop to prevent infinite subscription leaks)
...
if __name__ == '__main__':
    try:
        rospy.loginfo("Starting joint_state_node...")
        talker()
