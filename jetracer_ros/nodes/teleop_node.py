#!/usr/bin/env python3
# WARNING: This node explicitly requires Python 3 because it relies on getkey for terminal input.
...
def teleop():
    ...
    #Print contol hints
    rospy.loginfo("Running teleop.py")
    rospy.loginfo("W: Forward")
    rospy.loginfo("A: Steer Left")
    rospy.loginfo("S: Backward")
    rospy.loginfo("D: Steer Right")
    rospy.loginfo("Q: Throttle stop")
    rospy.loginfo("E: Steering reset")
